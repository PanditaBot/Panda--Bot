...
let pp = gataImg
const cat = `𝐏𝐚𝐧𝐝𝐢𝐭𝐚𝐁𝐨𝐭🐼
* ${bot}

*---------------------*

*IG*
*https://www.instagram.com/pandita_bot*
...
correo = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? 'PandaBot' : official[1][0] == String(contact[0]) ? 'PandaBot' : official[2][0] == String(contact[0]) ? 'PandaBot' : official[3][0] == String(contact[0]) ? 'PandaBot' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : official[3][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : md 
lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.instagram.com/pandita_bot' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'https://www.instagram.com/pandita_bot' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 𝐏𝐚𝐧𝐝𝐢𝐭𝐚𝐁𝐨𝐭 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
