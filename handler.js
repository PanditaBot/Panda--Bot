...
//this.reply(m.chat, `🐼 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝐏𝐀𝐍𝐃𝐈𝐓𝐀𝘾𝙊𝙄𝙉𝙎`, m)
this.sendMessage(m.chat, {text: `🐼 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝐏𝐀𝐍𝐃𝐈𝐓𝐀𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: wm, previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
if (m.money)
m.reply(+m.money + ' 𝐏𝐀𝐍𝐃𝐈𝐓𝐀𝘾𝙊𝙄𝙉𝙎 🐱 𝙐𝙎𝘼𝘿𝙊(𝙎)')  
break
}}} catch (e) {
console.error(e)
} finally {
